...
<h1><?php echo $_SESSION['username']; ?></h1>
	...
	<div class="content">
		<div id="topics">
			<a href="general-videos.php"><img class="videos" src="videos.png" alt="Videos"></a>
			<a href="general.pdf" download><img class="pdfs" src="pdfs.png" alt="PDFs"></a>
			<a href="general-lesson.php"><img class="lesson" src="lesson.png" alt="Lesson"></a>
			<a href="general-quiz.php"><img class="quiz" src="quiz.png" alt="Quiz"></a>
		</div>
