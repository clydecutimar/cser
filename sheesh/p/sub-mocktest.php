...
<h1>Sub-Professional Mock Test</h1>
<p id="timer">5:00</p>
<form id="quiz-form">
  <div class="question">
    <p>	Which of the following words means "the quality of being honest and having strong moral principles"?</p>
    <label>
  ...
  <div class="question">
    <p>	Which of the following words means "an expression of strong disapproval or harsh criticism"?</p>
    <label>
  ...
  <div class="question">
    <p>	Which of the following words means "to give up a position, right, or power"?</p>
    <label>
  ...
  <div class="question">
    <p>	Which of the following words means "to give up or disavow a belief or principle"?</p>
    <label>
  ...
  <div class="question">
    <p>	Which of the following words means "to go beyond what is necessary or desired"?</p>
    <label>
    ...
    <p>	Which of the following is correct?</p>
      ...
      <div class="question">
        <p>	Which of the following is a correctly punctuated sentence?</p>
        <label>
          <input type="radio" name="question2" value="a">
      ...
      <div class="question">
        <p>	Which of the following is a correctly formed sentence?</p>
        <label>
          <input type="radio" name="question3" value="a">
      ...
      <div class="question">
        ...
        <p>	A. One effective way is to diversify his funds to different investments like real estate, stocks and
      ...
      <div class="question">
        <p>	A. It is very vital to have social media presence however personal blogs serve as web domains.</p>
      ...
      <div class="question">
        <p>	A. The basic steps in building a website are easy to remember and registering a domain name is the
            usual priority.</p>
      ...
      <div class="question">
        <p>	A. Speaking in English every day is also proven effective.</p>
      ...
      <div class="question">
        <p>	A. Others don’t realize yet what to pursue because they have many dreams.</p>
      ...
      <div class="question">
        <p>	Most researchers in needy countries are based on the thinking and approach of the highly developed Western world, and seldom have they been directed toward meeting the countries; own development needs. The sentence best supports the statement that _________.</p>
        <label>
          <input type="radio" name="question2" value="a">
      ...
      <div class="question">
        <p>	Two person look out through the same bars; one sees mud and the other, the stars. The sentence best supports the statement that__________.</p>
        <label>
          <input type="radio" name="question4" value="a">
      ...
      <div class="question">
        <p>	Nagawang mabago ng mga kasalukuyang awitin ang kamalayan ng Pilipino upang kantahin ang sarili niyang mga awit sa tanging wikang nakapagsasatinig sa kanyang kaluluwa. Isinasaad ng pangungusap na __________.</p>
        <label>
          <input type="radio" name="question5" value="a">
      ...
      <div class="question">
        <p>	Simplify: 33 1/3 % of 48 + 12 1⁄2 % of 96 – 44 4/9 % of 27</p>
        <label>
          <input type="radio" name="question3" value="a">
          12
        </label>
      ...
      <div class="question">
        ...
        <p>	The official motto used in 30th Southeast Asian Games is what?</p>
        <label>
          <input type="radio" name="question1" value="a">
          We Care As One 
        </label>
      ...
      <div class="question">
        <p>	On August 16, 2018, the government announced at least ___ Philippine holidays for 2019 as declared by virtue of Proclamation No. 555, series of 2018.</p>
        <label>
          <input type="radio" name="question2" value="a">
          16
        </label>
      ...
      <div class="question">
        <p>	Which of the following statements best describes the relationship between global warming ozone depletion?</p>
        <label>
          <input type="radio" name="question3" value="a">
      ...
      <div class="question">
        <p>	It is only Philippine province with an English name.</p>
        <label>
          <input type="radio" name="question4" value="a">
          Cebu
        </label>
      ...
      <div class="question">
        <p>	What form of government does the Philippines adopt?</p>
        <label>
          <input type="radio" name="question5" value="a">
          Republican
        </label>
        ...
        <p>	Which of the following words is spelled correctly?</p>
        <label>
          <input type="radio" name="question1" value="a">
          Accross 
        </label>
      ...
      <div class="question">
        ...
        <p>	Which of the following is an example of clerical operations?</p>
        <label>
          <input type="radio" name="question1" value="a">
      ...
      <div class="question">
        <p>	What is the primary purpose of filing documents in a clerical office?</p>
        <label>
          <input type="radio" name="question2" value="a">
      ...
      <div class="question">
        <p>	Which of the following is NOT a benefit of using technology in clerical operations?</p>
        <label>
          <input type="radio" name="question3" value="a">
      ...
      <div class="question">
        <p>	What is the purpose of data entry in clerical operations?</p>
        <label>
          <input type="radio" name="question4" value="a">
          To create new data 
        </label>
      ...
      <div class="question">
        <p>	What is the difference between data and information?</p>
        <label>
          <input type="radio" name="question5" value="a">
...
<button id="retake-button" type="button">Retake Quiz</button>
	...
	<script src="sub-mocktest.js"></script>
</body>
</html>