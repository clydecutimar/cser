...
const answerKey = ['a', 'd', 'b', 'c', 'c', 'b', 'b', 'c', 'b', 'b', 'c', 'b', 'b', 'a', 'd', 'a', 'd', 'd', 'c', 'd', 'b', 'a', 'b', 'a', 'd', 'b', 'a', 'b', 'd', 'b', 'b', 'd', 'c', 'a', 'a', 'c', 'c', 'c', 'd', 'a', 'd', 'a', 'a', 'b', 'b', 'a', 'b', 'a', 'a', 'c'];
let timeLeft = 2400; // 5 minutes in seconds
let timerIntervalId;
