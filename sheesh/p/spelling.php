...
<h1><?php echo $_SESSION['username']; ?></h1>
	...
	<div class="content">
		<div id="topics">
			<a href="spelling-videos.php"><img class="videos" src="videos.png" alt="Videos"></a>
			<a href="spelling.pdf" download><img class="pdfs" src="pdfs.png" alt="PDFs"></a>
			<a href="spelling-lesson.php"><img class="lesson" src="lesson.png" alt="Lesson"></a>
			<a href="spelling-quiz.php"><img class="quiz" src="quiz.png" alt="Quiz"></a>	
		</div>
