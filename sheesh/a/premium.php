...
<html>
<head>
	<title>CSE ReviewBoost Admin Panel</title>
...
<body>
	...
	<header>
		<div id="header-title">CSE ReviewBoost Admin Panel</div>
	</header>
	...
	<div class="sidebar">
		...
		<a href="premium.php" class="active">Premium Plans</a>
        <a href="extend.php">Extend Plans</a>
	</div>
...
<br><br><br><label for="search">Search:</label>
